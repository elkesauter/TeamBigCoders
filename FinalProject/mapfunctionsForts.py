...
###################FLICKR PHOTOS###############################
def flickrmap(api_key,api_secret,tag):
    import flickrapi
    import folium
...
def featuremap(lijst,lijstflickr,lijstPC,distancelimit,name2,locationself):
    import folium
    
    #create map
    map2 = folium.Map(location=locationself)
...
<div class="gallery" align="center">
 ...
 """  
        ...
        folium.Marker([fort[0],fort[1]],popup=poppin,icon = iconnew).add_to(map2)
        code="" 
    map2.save(name2)
